class Tswift < DiasoftRecord
  self.table_name = 'tSwift'
  self.primary_key = 'SwiftID'

  paginates_per 19

  # has_many    :tinstruments, foreign_key: 'InstrumentID',     foreign_type: :numeric, primary_key: 'InstrumentID'
